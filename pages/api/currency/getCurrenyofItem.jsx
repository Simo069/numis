...
export default async function handler(req, res) {
  if (req.method === "POST") {
    ...
    try {
      ...
      //   where: { id: parseInt(id), currencyId: parseInt(idcurrency) },
      // });
      const currencies = await db.currencies.findFirst({
        where: {
          id: parseInt(id),
          currencyId: parseInt(idcurrency),
        },
      });
